...
Modified by Jonathan Kula
Because JSConsole modifies the console attribute's type, this whole thing
has to be included... if anyone has a better solution, please tell me.
***************************************************************************** */
...
declare var console: JSConsole;
declare var systemConsole: Console;
/**
 * Fires when the user aborts the download.
 * @param ev The event.
 */
